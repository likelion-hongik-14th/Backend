...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args){
        ...
        Product prod1 = Product.builder().name("러닝화").description("착용감이 뛰어난 러닝화").price(200000).stock(50).build();
        Product prod2 = Product.builder().name("자전거").description("가볍고 내구성이 좋은 자전거").price(400000).stock(30).build();
