...
public class CartService {
    ...
    // [공통] 내 장바구니 가져오기
    private Cart getTestCart(Long userId){
    ...
    // [수정] 장바구니 상품의 수량만 변경
    @Transactional
    public void updateCartItemQuantity(Long cartItemId, Long userId, CartItemUpdateDto updateDto){
