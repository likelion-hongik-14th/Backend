...
public interface CartRepository extends JpaRepository<Cart, Long> {
    // 아이템이 없어도 장바구니 자체는 반환되게 LEFT JOIN FETCH를 사용함
    @Query("SELECT c FROM Cart c LEFT JOIN FETCH c.cartItems ci LEFT JOIN FETCH ci.product WHERE c.member.memberId = :memberId")
