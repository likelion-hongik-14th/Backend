...
public class OrderController {
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "CART400_1", description = "장바구니가 비어있습니다."),
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "ORDER404_1", description = "주문을 찾을 수 없습니다.")
    })
    @GetMapping("/{orderId}")
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "ORDER404_1", description = "주문을 찾을 수 없습니다."),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "ORDER400_1", description = "해당 상태로 변경할 수 없습니다.")
    })
