...
public class AddressController {
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "MEMBER404_1: 회원을 찾을 수 없습니다."),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "ADDRESS400_1: 배송지는 20개를 초과할 수 없습니다.")
    })
    @PostMapping
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "ADDRESS404_1: 배송지를 찾을 수 없습니다.")
    })
